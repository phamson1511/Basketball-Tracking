...
class PassInterceptionDrawer:
    ...
    def draw_frame(self, frame, frame_num, passes, interceptions):
        ...
        # === DI CHUYỂN XUỐNG GÓC DƯỚI CÙNG BÊN TRÁI ===
        # Hộp nền trắng sẽ chiếm từ sát mép trái (0) đến 48% chiều rộng, và từ 85% đến 98% chiều cao
        rect_x1 = int(frame_width * 0.02) 
        rect_y1 = int(frame_height * 0.84)
        rect_x2 = int(frame_width * 0.48)  
        rect_y2 = int(frame_height * 0.98)
        
        # Tọa độ chữ (thụt lề một chút so với viền hộp nền)
        text_x = int(frame_width * 0.04)  
